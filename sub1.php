                ...
                <div class="card shadow-sm" style="height: 100%;">
                    <div class="card-body">
                        ...
                        <div id="hasil" class="kelompok kelompok-non-tes d-none">
                            <h2 class="judul" style="position: relative"><?= htmlspecialchars($nama) ?><span id="hasil-waktu-tes"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar1;
                document.getElementById("jumlah-salah").innerHTML = jSalah1;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar1', jBenar1);
                localStorage.setItem('jSalah1', jSalah1);
                localStorage.setItem('scores1',  JSON.stringify(scores1));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar1');
                const jSalahLocal = localStorage.getItem('jSalah1');
                const scores1Local = localStorage.getItem('scores1');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores1Local !== null && scores1Local.trim() !== "") {
                        jBenar1 = parseInt(jBenarLocal);
                        jSalah1 = parseInt(jSalahLocal);
                        scores1 = JSON.parse(scores1Local); // Parse JSON string to array
            ...
            function decrement() {
                ...
                if (count < 0) {
                    document.location.href = 'sub2.php'
                } else {
        ...
        localStorage.jBenar1 = 0;
       localStorage.jSalah1 = 0;
       localStorage.scores1 =[];
    </script>
</body>
</html>