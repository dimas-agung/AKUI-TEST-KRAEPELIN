...
<head>
<script defer>
    sub4 = localStorage.getItem('scores9');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar10;
                document.getElementById("jumlah-salah").innerHTML = jSalah10;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar10', jBenar10);
                localStorage.setItem('jSalah10', jSalah10);
                localStorage.setItem('scores10',  JSON.stringify(scores10));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar10');
                const jSalahLocal = localStorage.getItem('jSalah10');
                const scores10Local = localStorage.getItem('scores10');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores10Local !== null && scores10Local.trim() !== "") {
                        jBenar10 = parseInt(jBenarLocal);
                        jSalah10 = parseInt(jSalahLocal);
                        scores10 = JSON.parse(scores10Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    // alert('Waktu Habis');
                    document.location.href = 'sub11.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [5, 4, 5, 2, 8, 3, 7, 5, 5, 8, 4, 6, 0, 8, 5, 1, 9, 5, 0, 1, 6, 5, 9];
...
//akhirLocalstorage  
        ...
        localStorage.jBenar10 = 0;
       localStorage.jSalah10 = 0;
       localStorage.scores10 =[];
    </script>
</body>
