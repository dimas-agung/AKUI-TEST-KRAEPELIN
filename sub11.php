...
<head>
<script defer>
    sub4 = localStorage.getItem('scores10');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar11;
                document.getElementById("jumlah-salah").innerHTML = jSalah11;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar11', jBenar11);
                localStorage.setItem('jSalah11', jSalah11);
                localStorage.setItem('scores11',  JSON.stringify(scores11));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar11');
                const jSalahLocal = localStorage.getItem('jSalah11');
                const scores11Local = localStorage.getItem('scores11');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores11Local !== null && scores11Local.trim() !== "") {
                        jBenar11 = parseInt(jBenarLocal);
                        jSalah11 = parseInt(jSalahLocal);
                        scores11 = JSON.parse(scores11Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    // alert('Waktu Habis');
                    document.location.href = 'sub12.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [4, 6, 5, 9, 5, 5, 1, 4, 4, 9, 5, 4, 6, 3, 5, 5, 1, 0, 5, 9, 8, 7];
...
//akhirLocalstorage  
        ...
        localStorage.jBenar11 = 0;
       localStorage.jSalah11 = 0;
       localStorage.scores11 =[];
    </script>
</body>
