...
<head>
<script defer>
    sub4 = localStorage.getItem('scores11');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar12;
                document.getElementById("jumlah-salah").innerHTML = jSalah12;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar12', jBenar12);
                localStorage.setItem('jSalah12', jSalah12);
                localStorage.setItem('scores12',  JSON.stringify(scores12));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar12');
                const jSalahLocal = localStorage.getItem('jSalah12');
                const scores12Local = localStorage.getItem('scores12');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores12Local !== null && scores12Local.trim() !== "") {
                        jBenar12 = parseInt(jBenarLocal);
                        jSalah12 = parseInt(jSalahLocal);
                        scores12 = JSON.parse(scores12Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    // alert('Waktu Habis');
                    document.location.href = 'sub13.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [5, 4, 6, 6, 4, 6, 5, 2, 3, 5, 6, 4, 5, 9, 0, 5, 8, 6, 4, 6, 5, 5];
...
//akhirLocalstorage  
       ...
       localStorage.jBenar12 = 0;
       localStorage.jSalah12 = 0;
       localStorage.scores12 =[];
    </script>
</body>
