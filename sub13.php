...
<head>
<script defer>
    sub4 = localStorage.getItem('scores12');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar13;
                document.getElementById("jumlah-salah").innerHTML = jSalah13;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar13', jBenar13);
                localStorage.setItem('jSalah13', jSalah13);
                localStorage.setItem('scores13',  JSON.stringify(scores13));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar13');
                const jSalahLocal = localStorage.getItem('jSalah13');
                const scores13Local = localStorage.getItem('scores13');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores13Local !== null && scores13Local.trim() !== "") {
                        jBenar13 = parseInt(jBenarLocal);
                        jSalah13 = parseInt(jSalahLocal);
                        scores13 = JSON.parse(scores13Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    // ('Waktu Habialerts');
                    document.location.href = 'sub14.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [9, 9, 8, 5, 1, 9, 5, 5 , 4, 5, 6, 4, 9, 0, 5, 1, 4, 5, 9, 6, 6, 7, 9];
...
//akhirLocalstorage  
        ...
        localStorage.jBenar13 = 0;
       localStorage.jSalah13 = 0;
       localStorage.scores13 =[];
    </script>
</body>
