...
<head>
<script defer>
    sub4 = localStorage.getItem('scores13');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar14;
                document.getElementById("jumlah-salah").innerHTML = jSalah14;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar14', jBenar14);
                localStorage.setItem('jSalah14', jSalah14);
                localStorage.setItem('scores14',  JSON.stringify(scores14));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar14');
                const jSalahLocal = localStorage.getItem('jSalah14');
                const scores14Local = localStorage.getItem('scores14');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores14Local !== null && scores14Local.trim() !== "") {
                        jBenar14 = parseInt(jBenarLocal);
                        jSalah14 = parseInt(jSalahLocal);
                        scores14 = JSON.parse(scores14Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    // alert('Waktu Habis');
                    document.location.href = 'sub15.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [0, 5, 4, 0, 2, 0, 9, 7, 5, 3, 5, 8, 6, 4, 6, 0, 8, 5, 1, 9, 5, 5, 1];
...
//akhirLocalstorage    
        ...
        localStorage.jBenar14 = 0;
       localStorage.jSalah14 = 0;
       localStorage.scores14 =[];
    </script>
</body>
