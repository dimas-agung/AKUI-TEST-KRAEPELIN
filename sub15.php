...
<head>
<script defer>
    sub4 = localStorage.getItem('scores14');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar15;
                document.getElementById("jumlah-salah").innerHTML = jSalah15;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar15', jBenar15);
                localStorage.setItem('jSalah15', jSalah15);
                localStorage.setItem('scores15',  JSON.stringify(scores15));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar15');
                const jSalahLocal = localStorage.getItem('jSalah15');
                const scores15Local = localStorage.getItem('scores15');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores15Local !== null && scores15Local.trim() !== "") {
                        jBenar15 = parseInt(jBenarLocal);
                        jSalah15 = parseInt(jSalahLocal);
                        scores15 = JSON.parse(scores15Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    // alert('Waktu Habis');
                    document.location.href = 'sub16.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [8, 5, 1, 9, 6, 4, 6, 5, 5, 6, 4, 9, 8, , 5, 4, 6, 3, 8, 5, 6, 4, 6, 5];
...
//akhirLocalstorage  
        ...
        localStorage.jBenar15 = 0;
       localStorage.jSalah15 = 0;
       localStorage.scores15 =[];
    </script>
</body>
