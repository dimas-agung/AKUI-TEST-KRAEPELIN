...
<head>
<script defer>
    sub4 = localStorage.getItem('scores15');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar16;
                document.getElementById("jumlah-salah").innerHTML = jSalah16;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar16', jBenar16);
                localStorage.setItem('jSalah16', jSalah16);
                localStorage.setItem('scores16',  JSON.stringify(scores16));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar16');
                const jSalahLocal = localStorage.getItem('jSalah16');
                const scores16Local = localStorage.getItem('scores16');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores16Local !== null && scores16Local.trim() !== "") {
                        jBenar16 = parseInt(jBenarLocal);
                        jSalah16 = parseInt(jSalahLocal);
                        scores16 = JSON.parse(scores16Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    // alert('Waktu Habis');
                    document.location.href = 'sub17.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [5, 4, 5, 0, 6, 6, 7, 0, , 9, 5, 3, 5, 8, 6, 4, 5, 0, 4, 9, 8, 5, 4, 6];
...
//akhirLocalstorage              
        ...
        localStorage.jBenar16 = 0;
       localStorage.jSalah16 = 0;
       localStorage.scores16 =[];
    </script>
</body>
