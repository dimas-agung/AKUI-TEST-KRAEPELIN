...
<head>
<script defer>
    sub4 = localStorage.getItem('scores16');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar17;
                document.getElementById("jumlah-salah").innerHTML = jSalah17;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar17', jBenar17);
                localStorage.setItem('jSalah17', jSalah17);
                localStorage.setItem('scores17',  JSON.stringify(scores17));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar17');
                const jSalahLocal = localStorage.getItem('jSalah17');
                const scores17Local = localStorage.getItem('scores17');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores17Local !== null && scores17Local.trim() !== "") {
                        jBenar17 = parseInt(jBenarLocal);
                        jSalah17 = parseInt(jSalahLocal);
                        scores17 = JSON.parse(scores17Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub18.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [3, 5, 8, 5, 4, 2, 2, 8, 3, 5, 4, 5, 9, 6, 4, 9, 8, 5, , 4, 6, 2, 8, 9];
...
//akhirLocalstorage              
        ...
        localStorage.jBenar17 = 0;
       localStorage.jSalah17 = 0;
       localStorage.scores17 =[];
    </script>
</body>
