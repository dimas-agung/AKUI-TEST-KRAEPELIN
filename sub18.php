...
<head>
<script defer>
    sub4 = localStorage.getItem('scores17');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar18;
                document.getElementById("jumlah-salah").innerHTML = jSalah18;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar18', jBenar18);
                localStorage.setItem('jSalah18', jSalah18);
                localStorage.setItem('scores18',  JSON.stringify(scores18));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar18');
                const jSalahLocal = localStorage.getItem('jSalah18');
                const scores18Local = localStorage.getItem('scores18');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores18Local !== null && scores18Local.trim() !== "") {
                        jBenar18 = parseInt(jBenarLocal);
                        jSalah18 = parseInt(jSalahLocal);
                        scores18 = JSON.parse(scores18Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub19.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [2, 8, 0, 6, 4, 4, 5, 9, 6, 0, 9, 8, 5, 4, 6, 2, 8, 9, 6, 6, 7, 9, 5, 9];
...
//akhirLocalstorage              
        ...
        localStorage.jBenar18 = 0;
       localStorage.jSalah18 = 0;
       localStorage.scores18 =[];
    </script>
</body>
