...
<head>
<script defer>
    sub4 = localStorage.getItem('scores18');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar19;
                document.getElementById("jumlah-salah").innerHTML = jSalah19;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar19', jBenar19);
                localStorage.setItem('jSalah19', jSalah19);
                localStorage.setItem('scores19',  JSON.stringify(scores19));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar19');
                const jSalahLocal = localStorage.getItem('jSalah19');
                const scores19Local = localStorage.getItem('scores19');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores19Local !== null && scores19Local.trim() !== "") {
                        jBenar19 = parseInt(jBenarLocal);
                        jSalah19 = parseInt(jSalahLocal);
                        scores19 = JSON.parse(scores19Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub20.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [7, 9, 9, 0, 6, 5, 8, 4, 0, 9, 8, 5, 4, 6, 8, 9, 6, 6, 7, 9, 5, 9];
...
//akhirLocalstorage              
        ...
        localStorage.jBenar19 = 0;
       localStorage.jSalah19 = 0;
       localStorage.scores19 =[];
    </script>
</body>
