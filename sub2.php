    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar2;
                document.getElementById("jumlah-salah").innerHTML = jSalah2;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar2', jBenar2);
                localStorage.setItem('jSalah2', jSalah2);
                localStorage.setItem('scores2',  JSON.stringify(scores2));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar2');
                const jSalahLocal = localStorage.getItem('jSalah2');
                const scores2Local = localStorage.getItem('scores2');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores2Local !== null && scores2Local.trim() !== "") {
                        jBenar2 = parseInt(jBenarLocal);
                        jSalah2 = parseInt(jSalahLocal);
                        scores2 = JSON.parse(scores2Local); // Parse JSON string to array
            ...
            function decrement() {
                ...
                if (count < 0) {
                    document.location.href = 'sub3.php'
                } else {
        ...
        localStorage.jBenar2 = 0;
       localStorage.jSalah2 = 0;
       localStorage.scores2 =[];
