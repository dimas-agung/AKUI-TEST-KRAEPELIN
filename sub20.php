...
<head>
<script defer>
    sub4 = localStorage.getItem('scores19');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar20;
                document.getElementById("jumlah-salah").innerHTML = jSalah20;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar20', jBenar20);
                localStorage.setItem('jSalah20', jSalah20);
                localStorage.setItem('scores20',  JSON.stringify(scores20));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar20');
                const jSalahLocal = localStorage.getItem('jSalah20');
                const scores20Local = localStorage.getItem('scores20');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores20Local !== null && scores20Local.trim() !== "") {
                        jBenar20 = parseInt(jBenarLocal);
                        jSalah20 = parseInt(jSalahLocal);
                        scores20 = JSON.parse(scores20Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub21.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [1, 5, 9, 8, 5, 6, 6, 4, 5, 6, 7, 9, 0, 6, 7, 9, 9, 8, 5, 1, 9];
...
//akhirLocalstorage              
        ...
        localStorage.jBenar20 = 0;
       localStorage.jSalah20 = 0;
       localStorage.scores20 =[];
    </script>
</body>
