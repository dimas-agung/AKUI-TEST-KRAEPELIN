...
<head>
<script defer>
    sub4 = localStorage.getItem('scores20');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(2)").innerHTML = 7; // Replace 3 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(3)").innerHTML = 5; // Replace 7 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(4)").innerHTML = 5; // Replace 2 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar21;
                document.getElementById("jumlah-salah").innerHTML = jSalah21;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar21', jBenar21);
                localStorage.setItem('jSalah21', jSalah21);
                localStorage.setItem('scores21',  JSON.stringify(scores21));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar21');
                const jSalahLocal = localStorage.getItem('jSalah21');
                const scores21Local = localStorage.getItem('scores21');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores21Local !== null && scores21Local.trim() !== "") {
                        jBenar21 = parseInt(jBenarLocal);
                        jSalah21 = parseInt(jSalahLocal);
                        scores21 = JSON.parse(scores21Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub22.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [6, 6, 1, 0, 5, 2, 5, 3, 5, 5, 9, 6, 6, 5, 1, 5, 1, 0, 5, 5, 1, 6, 5];
...
//akhirLocalstorage              
        ...
        localStorage.jBenar21 = 0;
       localStorage.jSalah21 = 0;
       localStorage.scores21 =[];
    </script>
</body>
