...
<head>
<script defer>
    sub4 = localStorage.getItem('scores21');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar22;
                document.getElementById("jumlah-salah").innerHTML = jSalah22;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar22', jBenar22);
                localStorage.setItem('jSalah22', jSalah22);
                localStorage.setItem('scores22',  JSON.stringify(scores22));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar22');
                const jSalahLocal = localStorage.getItem('jSalah22');
                const scores22Local = localStorage.getItem('scores22');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores22Local !== null && scores22Local.trim() !== "") {
                        jBenar22 = parseInt(jBenarLocal);
                        jSalah22 = parseInt(jSalahLocal);
                        scores22 = JSON.parse(scores22Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub23.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [6, 5, 0, 5, 1, 9, 5, 5, 1, 5, 8, 4, 5, 9, 6, 6, 7, 9, 9, 8, 5, 1, 9];
...
//akhirLocalstorage              
        ...
        localStorage.jBenar22 = 0;
       localStorage.jSalah22 = 0;
       localStorage.scores22 =[];
    </script>
</body>
