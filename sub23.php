...
<head>
<script defer>
    sub4 = localStorage.getItem('scores22');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar23;
                document.getElementById("jumlah-salah").innerHTML = jSalah23;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar23', jBenar23);
                localStorage.setItem('jSalah23', jSalah23);
                localStorage.setItem('scores23',  JSON.stringify(scores23));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar23');
                const jSalahLocal = localStorage.getItem('jSalah23');
                const scores23Local = localStorage.getItem('scores23');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores23Local !== null && scores23Local.trim() !== "") {
                        jBenar23 = parseInt(jBenarLocal);
                        jSalah23 = parseInt(jSalahLocal);
                        scores23 = JSON.parse(scores23Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub24.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [8, 5, 8, 0, 2, 8, 9, 7, 5, 5, 0, 5, 5, 1, 6, 6, 4, 6, 5, 5, 4, 5, 9];
...
//akhirLocalstorage              
        ...
        localStorage.jBenar23 = 0;
       localStorage.jSalah23 = 0;
       localStorage.scores23 =[];
    </script>
</body>
