...
<head>
<script defer>
    sub4 = localStorage.getItem('scores23');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar24;
                document.getElementById("jumlah-salah").innerHTML = jSalah24;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar24', jBenar24);
                localStorage.setItem('jSalah24', jSalah24);
                localStorage.setItem('scores24',  JSON.stringify(scores24));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar24');
                const jSalahLocal = localStorage.getItem('jSalah24');
                const scores24Local = localStorage.getItem('scores24');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores24Local !== null && scores24Local.trim() !== "") {
                        jBenar24 = parseInt(jBenarLocal);
                        jSalah24 = parseInt(jSalahLocal);
                        scores24 = JSON.parse(scores24Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub25.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [9, 8, 5, 1, 9, 5, 5, 1, 4, 5, 8, 5, 6, 5, 5, 6, 0, 7, 9, 9, 8, 0, 1];
...
//akhirLocalstorage              
        ...
        localStorage.jBenar24 = 0;
       localStorage.jSalah24 = 0;
       localStorage.scores24 =[];
    </script>
</body>
