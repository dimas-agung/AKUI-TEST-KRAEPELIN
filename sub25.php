...
<head>
<script defer>
    sub4 = localStorage.getItem('scores24');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar25;
                document.getElementById("jumlah-salah").innerHTML = jSalah25;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar25', jBenar25);
                localStorage.setItem('jSalah25', jSalah25);
                localStorage.setItem('scores25',  JSON.stringify(scores25));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar25');
                const jSalahLocal = localStorage.getItem('jSalah25');
                const scores25Local = localStorage.getItem('scores25');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores25Local !== null && scores25Local.trim() !== "") {
                        jBenar25 = parseInt(jBenarLocal);
                        jSalah25 = parseInt(jSalahLocal);
                        scores25 = JSON.parse(scores25Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub26.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [8, 3, 5, 8, 6, 4, 6, 5, 8, 4, 9, 5, 4, 6, 2, 5, 1, 2, 2, , 8, 3, 5, 8];
...
//akhirLocalstorage              
        ...
        localStorage.jBenar25 = 0;
       localStorage.jSalah25 = 0;
       localStorage.scores25 =[];
    </script>
</body>
