...
<head>
<script defer>
    sub4 = localStorage.getItem('scores25');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar26;
                document.getElementById("jumlah-salah").innerHTML = jSalah26;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar26', jBenar26);
                localStorage.setItem('jSalah26', jSalah26);
                localStorage.setItem('scores26',  JSON.stringify(scores26));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar26');
                const jSalahLocal = localStorage.getItem('jSalah26');
                const scores26Local = localStorage.getItem('scores26');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores26Local !== null && scores26Local.trim() !== "") {
                        jBenar26 = parseInt(jBenarLocal);
                        jSalah26 = parseInt(jSalahLocal);
                        scores26 = JSON.parse(scores26Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub27.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [3, 5, 8, 5, 4, 2, 2, 8, 3, 3, 5, 6, 4, 0, 8, 5, 5, 4, 5, 0, 6, 4, 9];
...
//akhirLocalstorage              
        ...
        localStorage.jBenar26 = 0;
       localStorage.jSalah26 = 0;
       localStorage.scores26 =[];
