...
<head>
<script defer>
    sub4 = localStorage.getItem('scores26');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(1)").innerHTML = 5; // Replace 5 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(2)").innerHTML = 5; // Replace 3 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(3)").innerHTML = 0; // Replace 7 with your desired number
...
//localstorage
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar27;
                document.getElementById("jumlah-salah").innerHTML = jSalah27;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar27', jBenar27);
                localStorage.setItem('jSalah27', jSalah27);
                localStorage.setItem('scores27',  JSON.stringify(scores27));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar27');
                const jSalahLocal = localStorage.getItem('jSalah27');
                const scores27Local = localStorage.getItem('scores27');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores27Local !== null && scores27Local.trim() !== "") {
                        jBenar27 = parseInt(jBenarLocal);
                        jSalah27 = parseInt(jSalahLocal);
                        scores27 = JSON.parse(scores27Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    document.location.href = 'sub28.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [2, 8, 0, 6, 4, 4, 5, 9, 6, 4, 5, 6, 6, 7, 9, 6, 5, 9, 8, 7, 5, 3, 5];
...
//akhirLocalstorage                    
        ...
        localStorage.jBenar27 = 0;
       localStorage.jSalah27 = 0;
       localStorage.scores27 =[];
    </script>
</body>
