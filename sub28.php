...
<head>
<script defer>
    sub4 = localStorage.getItem('scores27');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar28;
                document.getElementById("jumlah-salah").innerHTML = jSalah28;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar28', jBenar28);
                localStorage.setItem('jSalah28', jSalah28);
                localStorage.setItem('scores28',  JSON.stringify(scores28));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar28');
                const jSalahLocal = localStorage.getItem('jSalah28');
                const scores28Local = localStorage.getItem('scores28');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores28Local !== null && scores28Local.trim() !== "") {
                        jBenar28 = parseInt(jBenarLocal);
                        jSalah28 = parseInt(jSalahLocal);
                        scores28 = JSON.parse(scores28Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    document.location.href = 'sub29.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [7, 9, 9, 0, 6, 9, 8, 7, 0, 9, 8, 8, 5, 1, 9, 4, 9, 8, 5, 4, 6, 2, 8];
...
//akhirLocalstorage       
        ...
        localStorage.jBenar28 = 0;
       localStorage.jSalah28 = 0;
       localStorage.scores28 =[];
    </script>
</body>
