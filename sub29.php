...
<head>
<script defer>
    sub4 = localStorage.getItem('scores28');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(2)").innerHTML = 6; // Replace 3 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar29;
                document.getElementById("jumlah-salah").innerHTML = jSalah29;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar29', jBenar29);
                localStorage.setItem('jSalah29', jSalah29);
                localStorage.setItem('scores29',  JSON.stringify(scores29));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar29');
                const jSalahLocal = localStorage.getItem('jSalah29');
                const scores29Local = localStorage.getItem('scores29');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores29Local !== null && scores29Local.trim() !== "") {
                        jBenar29 = parseInt(jBenarLocal);
                        jSalah29 = parseInt(jSalahLocal);
                        scores29 = JSON.parse(scores29Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub30.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [1, 5, 9, 8, 5, 9, 6, 4, 5, 8, 5, 9, 5, 5, 1, 6, 0, 7, 9, 6, 0, 7, 9];
...
//akhirLocalstorage       
        ...
        localStorage.jBenar29 = 0;
       localStorage.jSalah29 = 0;
       localStorage.scores29 =[];
    </script>
</body>
