...
<head>
<script defer>
    sub4 = localStorage.getItem('scores29');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(1)").innerHTML = 2; // Replace 5 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar30;
                document.getElementById("jumlah-salah").innerHTML = jSalah30;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar30', jBenar30);
                localStorage.setItem('jSalah30', jSalah30);
                localStorage.setItem('scores30',  JSON.stringify(scores30));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar30');
                const jSalahLocal = localStorage.getItem('jSalah30');
                const scores30Local = localStorage.getItem('scores30');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores30Local !== null && scores30Local.trim() !== "") {
                        jBenar30 = parseInt(jBenarLocal);
                        jSalah30 = parseInt(jSalahLocal);
                        scores30 = JSON.parse(scores30Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub31.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [6, 6, 1, 0, 5, 7, 5, 3, 5, 7, 9, 8, 9, 7, 5, 4, 5, 9, 6, 6, 5, 1, 5];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar30 = 0;
       localStorage.jSalah30 = 0;
       localStorage.scores30 =[];
    </script>
</body>
