...
<head>
<script defer>
    sub4 = localStorage.getItem('scores30');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar31;
                document.getElementById("jumlah-salah").innerHTML = jSalah31;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar31', jBenar31);
                localStorage.setItem('jSalah31', jSalah31);
                localStorage.setItem('scores31',  JSON.stringify(scores31));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar31');
                const jSalahLocal = localStorage.getItem('jSalah31');
                const scores31Local = localStorage.getItem('scores31');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores31Local !== null && scores31Local.trim() !== "") {
                        jBenar31 = parseInt(jBenarLocal);
                        jSalah31 = parseInt(jSalahLocal);
                        scores31 = JSON.parse(scores31Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub32.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [6, 5, 0, 5, 1, 9, 5, 5, 1, 0, 6, 5, 5, 1, 4, 8, 9, 7, 5, 8, 5, 8, 6];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar31 = 0;
       localStorage.jSalah31 = 0;
       localStorage.scores31 =[];
    </script>
</body>
