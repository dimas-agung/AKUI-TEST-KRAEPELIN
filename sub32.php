...
<head>
<script defer>
    sub4 = localStorage.getItem('scores31');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar32;
                document.getElementById("jumlah-salah").innerHTML = jSalah32;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar32', jBenar32);
                localStorage.setItem('jSalah32', jSalah32);
                localStorage.setItem('scores32',  JSON.stringify(scores32));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar32');
                const jSalahLocal = localStorage.getItem('jSalah32');
                const scores32Local = localStorage.getItem('scores32');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores32Local !== null && scores32Local.trim() !== "") {
                        jBenar32 = parseInt(jBenarLocal);
                        jSalah32 = parseInt(jSalahLocal);
                        scores32 = JSON.parse(scores32Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub33.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [8, 5, 8, 0, 2, 9, 8, 7, 5, 5, 8, 4, 6, 0, 8, 6, 6, 7, 9, 9, 8, 5, 1];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar32 = 0;
       localStorage.jSalah32 = 0;
       localStorage.scores32 =[];
    </script>
</body>
