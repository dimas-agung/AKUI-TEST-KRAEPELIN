...
<head>
<script defer>
    sub4 = localStorage.getItem('scores32');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(1)").innerHTML = 9; // Replace 5 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(2)").innerHTML = 9; // Replace 3 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(3)").innerHTML = 8; // Replace 7 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(4)").innerHTML = 7; // Replace 2 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar33;
                document.getElementById("jumlah-salah").innerHTML = jSalah33;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar33', jBenar33);
                localStorage.setItem('jSalah33', jSalah33);
                localStorage.setItem('scores33',  JSON.stringify(scores33));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar33');
                const jSalahLocal = localStorage.getItem('jSalah33');
                const scores33Local = localStorage.getItem('scores33');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores33Local !== null && scores33Local.trim() !== "") {
                        jBenar33 = parseInt(jBenarLocal);
                        jSalah33 = parseInt(jSalahLocal);
                        scores33 = JSON.parse(scores33Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub34.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [9, 8, 5, 1, 9, 5, 5, 1, 4, 4, 9, 5, 4, 6, 3, 5, 1, 2, 2, 8, 3, 5, 8];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar33 = 0;
       localStorage.jSalah33 = 0;
       localStorage.scores33 =[];
    </script>
</body>
