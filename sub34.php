...
<head>
<script defer>
    sub4 = localStorage.getItem('scores33');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar34;
                document.getElementById("jumlah-salah").innerHTML = jSalah34;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar34', jBenar34);
                localStorage.setItem('jSalah34', jSalah34);
                localStorage.setItem('scores34',  JSON.stringify(scores34));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar34');
                const jSalahLocal = localStorage.getItem('jSalah34');
                const scores34Local = localStorage.getItem('scores34');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores34Local !== null && scores34Local.trim() !== "") {
                        jBenar34 = parseInt(jBenarLocal);
                        jSalah34 = parseInt(jSalahLocal);
                        scores34 = JSON.parse(scores34Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub35.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [8, 3, 5, 8, 6, 4, 6, 5, 8, 3, 5, 6, 4, 5, 6, 5, 5, 4, 5, 9, 6, 4, 9];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar34 = 0;
       localStorage.jSalah34 = 0;
       localStorage.scores34 =[];
    </script>
</body>
