...
<head>
<script defer>
    sub4 = localStorage.getItem('scores34');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(1)").innerHTML = 7; // Replace 5 with your desired number
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(5)").innerHTML = 6; // Replace 9 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar35;
                document.getElementById("jumlah-salah").innerHTML = jSalah35;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar35', jBenar35);
                localStorage.setItem('jSalah35', jSalah35);
                localStorage.setItem('scores35',  JSON.stringify(scores35));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar35');
                const jSalahLocal = localStorage.getItem('jSalah35');
                const scores35Local = localStorage.getItem('scores35');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores35Local !== null && scores35Local.trim() !== "") {
                        jBenar35 = parseInt(jBenarLocal);
                        jSalah35 = parseInt(jSalahLocal);
                        scores35 = JSON.parse(scores35Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub36.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [7, 9, 9, 8, 5, 1, 9, 5, 5, 4, 5, 6, 4, 9, 0, 6, 5, 0, 8, 7, 5, 3, 5];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar35 = 0;
       localStorage.jSalah35 = 0;
       localStorage.scores35 =[];
    </script>
</body>
