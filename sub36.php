...
<head>
<script defer>
    sub4 = localStorage.getItem('scores35');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar36;
                document.getElementById("jumlah-salah").innerHTML = jSalah36;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar36', jBenar36);
                localStorage.setItem('jSalah36', jSalah36);
                localStorage.setItem('scores36',  JSON.stringify(scores36));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar36');
                const jSalahLocal = localStorage.getItem('jSalah36');
                const scores36Local = localStorage.getItem('scores36');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores36Local !== null && scores36Local.trim() !== "") {
                        jBenar36 = parseInt(jBenarLocal);
                        jSalah36 = parseInt(jSalahLocal);
                        scores36 = JSON.parse(scores36Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub37.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [2, 2, 0, 3, 5, 8, 6, 4, 6, 0, 8, 5, 3, 5, 8, 5, 4, 2, 2, 8, 3, 5, 8];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar36 = 0;
       localStorage.jSalah36 = 0;
       localStorage.scores36 =[];
    </script>
</body>
