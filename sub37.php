...
<head>
<script defer>
    sub4 = localStorage.getItem('scores36');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(5)").innerHTML = 4; // Replace 9 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar37;
                document.getElementById("jumlah-salah").innerHTML = jSalah37;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar37', jBenar37);
                localStorage.setItem('jSalah37', jSalah37);
                localStorage.setItem('scores37',  JSON.stringify(scores37));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar37');
                const jSalahLocal = localStorage.getItem('jSalah37');
                const scores37Local = localStorage.getItem('scores37');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores37Local !== null && scores37Local.trim() !== "") {
                        jBenar37 = parseInt(jBenarLocal);
                        jSalah37 = parseInt(jSalahLocal);
                        scores37 = JSON.parse(scores37Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub38.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [4, 5, 9, 0, 4, 9, 8, 5, 4, 5, 8, 6, 2, 8, 0, 6, 4, 4, 5, 9, 6, 4, 9];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar37 = 0;
       localStorage.jSalah37 = 0;
       localStorage.scores37 =[];
    </script>
</body>
