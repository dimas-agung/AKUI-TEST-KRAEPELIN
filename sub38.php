...
<head>
<script defer>
    sub4 = localStorage.getItem('scores37');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(1)").innerHTML = 6; // Replace 5 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(2)").innerHTML = 0; // Replace 3 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(3)").innerHTML = 5; // Replace 7 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(4)").innerHTML = 6; // Replace 2 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(5)").innerHTML = 0; // Replace 9 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar38;
                document.getElementById("jumlah-salah").innerHTML = jSalah38;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar38', jBenar38);
                localStorage.setItem('jSalah38', jSalah38);
                localStorage.setItem('scores38',  JSON.stringify(scores38));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar38');
                const jSalahLocal = localStorage.getItem('jSalah38');
                const scores38Local = localStorage.getItem('scores38');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores38Local !== null && scores38Local.trim() !== "") {
                        jBenar38 = parseInt(jBenarLocal);
                        jSalah38 = parseInt(jSalahLocal);
                        scores38 = JSON.parse(scores38Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub39.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [9, 0, 0, 8, 5, 4, 6, 2, 8, 4, 9, 0, 7, 9, 9, 0, 6, 9, 8, 7, 0, 3, 5];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar38 = 0;
       localStorage.jSalah38 = 0;
       localStorage.scores38 =[];
    </script>
</body>
