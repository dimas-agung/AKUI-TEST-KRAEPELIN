...
<head>
<script defer>
    sub4 = localStorage.getItem('scores38');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(5)").innerHTML = 8; // Replace 9 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar39;
                document.getElementById("jumlah-salah").innerHTML = jSalah39;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar39', jBenar39);
                localStorage.setItem('jSalah39', jSalah39);
                localStorage.setItem('scores39',  JSON.stringify(scores39));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar39');
                const jSalahLocal = localStorage.getItem('jSalah39');
                const scores39Local = localStorage.getItem('scores39');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores39Local !== null && scores39Local.trim() !== "") {
                        jBenar39 = parseInt(jBenarLocal);
                        jSalah39 = parseInt(jSalahLocal);
                        scores39 = JSON.parse(scores39Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub40.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [5, 9, 9, 8, 6, 4, 5, 8, 6, 3, 5, 5, 1, 5, 9, 8, 5, 9, 6, 4, 5, 4, 5];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar39 = 0;
       localStorage.jSalah39 = 0;
       localStorage.scores39 =[];
    </script>
</body>
