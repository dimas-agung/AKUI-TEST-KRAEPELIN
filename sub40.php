...
<head>
<script defer>
    sub4 = localStorage.getItem('scores39');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(3)").innerHTML = 4; // Replace 7 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(4)").innerHTML = 1; // Replace 2 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar40;
                document.getElementById("jumlah-salah").innerHTML = jSalah40;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar40', jBenar40);
                localStorage.setItem('jSalah40', jSalah40);
                localStorage.setItem('scores40',  JSON.stringify(scores40));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar40');
                const jSalahLocal = localStorage.getItem('jSalah40');
                const scores40Local = localStorage.getItem('scores40');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores40Local !== null && scores40Local.trim() !== "") {
                        jBenar40 = parseInt(jBenarLocal);
                        jSalah40 = parseInt(jSalahLocal);
                        scores40 = JSON.parse(scores40Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub41.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [5, 7, 1, 9, 6, 6, 7, 9, 5, 4, 5, 9, 6, 6, 1, 0, 5, 7, 5, 3, 5, 9, 8];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar40 = 0;
       localStorage.jSalah40 = 0;
       localStorage.scores40 =[];
    </script>
</body>
