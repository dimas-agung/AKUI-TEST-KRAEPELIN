...
<head>
<script defer>
    sub4 = localStorage.getItem('scores40');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar41;
                document.getElementById("jumlah-salah").innerHTML = jSalah41;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar41', jBenar41);
                localStorage.setItem('jSalah41', jSalah41);
                localStorage.setItem('scores41',  JSON.stringify(scores41));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar41');
                const jSalahLocal = localStorage.getItem('jSalah41');
                const scores41Local = localStorage.getItem('scores41');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores41Local !== null && scores41Local.trim() !== "") {
                        jBenar41 = parseInt(jBenarLocal);
                        jSalah41 = parseInt(jSalahLocal);
                        scores41 = JSON.parse(scores41Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub42.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [9, 0, 1, 9, 8, 5, 1, 9, 5, 5, 9, 6, 6, 5, 0, 5, 1, 9, 5, 5, 1, 6, 5];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar41 = 0;
       localStorage.jSalah41 = 0;
       localStorage.scores41 =[];
    </script>
</body>
