...
<head>
<script defer>
    sub4 = localStorage.getItem('scores41');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar42;
                document.getElementById("jumlah-salah").innerHTML = jSalah42;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar42', jBenar42);
                localStorage.setItem('jSalah42', jSalah42);
                localStorage.setItem('scores42',  JSON.stringify(scores42));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar42');
                const jSalahLocal = localStorage.getItem('jSalah42');
                const scores42Local = localStorage.getItem('scores42');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores42Local !== null && scores42Local.trim() !== "") {
                        jBenar42 = parseInt(jBenarLocal);
                        jSalah42 = parseInt(jSalahLocal);
                        scores42 = JSON.parse(scores42Local); // Parse JSON string to array
         ...
         //       timer.innerHTML = (`0${waktu / 60}`).slice(-2) + ":00";
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub43.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [6, 5, 1, 1, 0, 5, 5, 1, 6, 9, 7, 5, 8, 5, 8, 0, 2, 8, 9, 7, 5, 8, 6];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar42 = 0;
       localStorage.jSalah42 = 0;
       localStorage.scores42 =[];
    </script>
</body>
