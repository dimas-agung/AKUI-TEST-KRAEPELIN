...
<head>
<script defer>
    sub4 = localStorage.getItem('scores42');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(3)").innerHTML = 9; // Replace 7 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar43;
                document.getElementById("jumlah-salah").innerHTML = jSalah43;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar43', jBenar43);
                localStorage.setItem('jSalah43', jSalah43);
                localStorage.setItem('scores43',  JSON.stringify(scores43));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar43');
                const jSalahLocal = localStorage.getItem('jSalah43');
                const scores43Local = localStorage.getItem('scores43');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores43Local !== null && scores43Local.trim() !== "") {
                        jBenar43 = parseInt(jBenarLocal);
                        jSalah43 = parseInt(jSalahLocal);
                        scores43 = JSON.parse(scores43Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub44.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [8, 5, 8, 7, 9, 9, 8, 5, 1, 6, 7, 9, 9, 8, 5, 1, 9, 5, 5, 1, 4, 5, 9];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar43 = 0;
       localStorage.jSalah43 = 0;
       localStorage.scores43 =[];
    </script>
</body>
