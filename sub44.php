...
<head>
<script defer>
    sub4 = localStorage.getItem('scores43');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar44;
                document.getElementById("jumlah-salah").innerHTML = jSalah44;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar44', jBenar44);
                localStorage.setItem('jSalah44', jSalah44);
                localStorage.setItem('scores44',  JSON.stringify(scores44));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar44');
                const jSalahLocal = localStorage.getItem('jSalah44');
                const scores44Local = localStorage.getItem('scores44');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores44Local !== null && scores44Local.trim() !== "") {
                        jBenar44 = parseInt(jBenarLocal);
                        jSalah44 = parseInt(jSalahLocal);
                        scores44 = JSON.parse(scores44Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub45.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [9, 9, 8, 5, 1, 5, 5, 7, 5, 1, 2, 2, 8, 3, 5, 8, 6, 4, 6, 5, 8, 5, 1];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar44 = 0;
       localStorage.jSalah44 = 0;
       localStorage.scores44 =[];
    </script>
</body>
