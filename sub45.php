...
<head>
<script defer>
    sub4 = localStorage.getItem('scores44');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(1)").innerHTML = 4; // Replace 5 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(2)").innerHTML = 4; // Replace 3 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(3)").innerHTML = 5; // Replace 7 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(4)").innerHTML = 4; // Replace 2 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(5)").innerHTML = 2; // Replace 9 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar45;
                document.getElementById("jumlah-salah").innerHTML = jSalah45;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar45', jBenar45);
                localStorage.setItem('jSalah45', jSalah45);
                localStorage.setItem('scores45',  JSON.stringify(scores45));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar45');
                const jSalahLocal = localStorage.getItem('jSalah45');
                const scores45Local = localStorage.getItem('scores45');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores45Local !== null && scores45Local.trim() !== "") {
                        jBenar45 = parseInt(jBenarLocal);
                        jSalah45 = parseInt(jSalahLocal);
                        scores45 = JSON.parse(scores45Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub46.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [2, 0, 3, 5, 8, 4, 6, 9, 5, 5, 0, 5, 9, 6, 4, 9, 0, 5, 4, 6, 0, 5, 8];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar45 = 45;
       localStorage.jSalah45 = 45;
       localStorage.scores45 =[];
    </script>
</body>
