...
<head>
<script defer>
    sub4 = localStorage.getItem('scores45');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar46;
                document.getElementById("jumlah-salah").innerHTML = jSalah46;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar46', jBenar46);
                localStorage.setItem('jSalah46', jSalah46);
                localStorage.setItem('scores46',  JSON.stringify(scores46));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar46');
                const jSalahLocal = localStorage.getItem('jSalah46');
                const scores46Local = localStorage.getItem('scores46');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores46Local !== null && scores46Local.trim() !== "") {
                        jBenar46 = parseInt(jBenarLocal);
                        jSalah46 = parseInt(jSalahLocal);
                        scores46 = JSON.parse(scores46Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub47.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [5, 9, 6, 4, 9, 5, 4, 1, 6, 5, 9, 8, 7, 5, 3, 5, 8, 6, 4, 5, 6, 4, 9];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar46 = 0;
       localStorage.jSalah46 = 0;
       localStorage.scores46 =[];
    </script>
</body>
