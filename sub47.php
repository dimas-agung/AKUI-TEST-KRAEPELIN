...
<head>
<script defer>
    sub4 = localStorage.getItem('scores46');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(4)").innerHTML = 0; // Replace 2 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar47;
                document.getElementById("jumlah-salah").innerHTML = jSalah47;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar47', jBenar47);
                localStorage.setItem('jSalah47', jSalah47);
                localStorage.setItem('scores47',  JSON.stringify(scores47));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar47');
                const jSalahLocal = localStorage.getItem('jSalah47');
                const scores47Local = localStorage.getItem('scores47');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores47Local !== null && scores47Local.trim() !== "") {
                        jBenar47 = parseInt(jBenarLocal);
                        jSalah47 = parseInt(jSalahLocal);
                        scores47 = JSON.parse(scores47Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub48.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [0, 0, 5, 3, 5, 6, 4, 5, 4, 0, 9, 6, 4, 5, 4, 5, 9, 6, 4, 9, 8, 5, 4];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar47 = 0;
       localStorage.jSalah47 = 0;
       localStorage.scores47 =[];
    </script>
</body>
