...
<head>
<script defer>
    sub4 = localStorage.getItem('scores47');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar48;
                document.getElementById("jumlah-salah").innerHTML = jSalah48;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar48', jBenar48);
                localStorage.setItem('jSalah48', jSalah48);
                localStorage.setItem('scores48',  JSON.stringify(scores48));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar48');
                const jSalahLocal = localStorage.getItem('jSalah48');
                const scores48Local = localStorage.getItem('scores48');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores48Local !== null && scores48Local.trim() !== "") {
                        jBenar48 = parseInt(jBenarLocal);
                        jSalah48 = parseInt(jSalahLocal);
                        scores48 = JSON.parse(scores48Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub49.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [9, 9, 5, 5, 4, 5, 9, 5, 9, 8, 7, 5, 3, 5, 9, 8, 7, 5, 3, 5, 8, 6, 4];
...
//akhirLocalstorage        
        ...
        localStorage.jBenar48 = 0;
       localStorage.jSalah48 = 0;
       localStorage.scores48 =[];
    </script>
</body>
