...
<head>
<script defer>
    sub4 = localStorage.getItem('scores48');
    if (!sub4) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(1)").innerHTML = 3; // Replace 5 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(2)").innerHTML = 9; // Replace 3 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(3)").innerHTML = 1; // Replace 7 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(4)").innerHTML = 9; // Replace 2 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(5)").innerHTML = 5; // Replace 9 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar49;
                document.getElementById("jumlah-salah").innerHTML = jSalah49;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar49', jBenar49);
                localStorage.setItem('jSalah49', jSalah49);
                localStorage.setItem('scores49',  JSON.stringify(scores49));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar49');
                const jSalahLocal = localStorage.getItem('jSalah49');
                const scores49Local = localStorage.getItem('scores49');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores49Local !== null && scores49Local.trim() !== "") {
                        jBenar49 = parseInt(jBenarLocal);
                        jSalah49 = parseInt(jSalahLocal);
                        scores49 = JSON.parse(scores49Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            function decrement() {
                ...
                if (count < 0) {
                    ...
                    document.location.href = 'sub50.php'
                } else {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [7, 1, 6, 5, 9, 8, 7, 9, 8, 0, 4, 6, 2, 9, 8, 0, 4, 6, 2, 8, 9, 0, 6];
...
//akhirLocalstorage        
       ...
       localStorage.jBenar49 = 0;
       localStorage.jSalah49 = 0;
       localStorage.scores49 =[];
    </script>
</body>
