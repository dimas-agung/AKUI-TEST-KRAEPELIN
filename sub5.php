...
<head>
<script defer>
    sub4 = localStorage.getItem('scores4');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar5;
                document.getElementById("jumlah-salah").innerHTML = jSalah5;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar5', jBenar5);
                localStorage.setItem('jSalah5', jSalah5);
                localStorage.setItem('scores5',  JSON.stringify(scores5));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar5');
                const jSalahLocal = localStorage.getItem('jSalah5');
                const scores5Local = localStorage.getItem('scores5');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores5Local !== null && scores5Local.trim() !== "") {
                        jBenar5 = parseInt(jBenarLocal);
                        jSalah5 = parseInt(jSalahLocal);
                        scores5 = JSON.parse(scores5Local); // Parse JSON string to array
            ...
            function decrement() {
                ...
                if (count < 0) {
                    document.location.href = 'sub6.php'
                } else {
            ...
            document.querySelectorAll("#tombol-nomor div").forEach((tn) => {
                tn.addEventListener("click", async () => {
                    ...
                    const angkaArray = [5, 4, 5, 4, 4, 5, 9, 6, 4, 5, 6, 6, 7, 9, 5, 1, 6, 5, 9, 8, 7, 5, 4];
        ...
        localStorage.jBenar5 = 0;
       localStorage.jSalah5 = 0;
       localStorage.scores5 =[];
    </script>
</body>
