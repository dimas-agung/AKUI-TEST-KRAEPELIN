...
<head>
<script defer>
    sub4 = localStorage.getItem('scores49');
    if (!sub4) {
                ...
                <div class="card shadow-sm" style="height: 100%;">
                    ...
                    <img id="logo" class="logo-non-tes"
                        ...
                        <div id="hitung-mundur" class="kelompok  kelompok-non-tes "
                            ...
                            <h2 class="judul text-center" style="margin-top: 10px;">Anda akan diarahkan ke halaman selanjutnya....</h2>
                            <p id="mundur">3</p>
                        </div>
                        ...
                        <div id="hasil" class="kelompok kelompok-non-tes d-none">
                            ...
                            <div id="hasil-pilihan-waktu"class=" d-none"style="margin-bottom: 15px;  ">
                                <button data-waktu-hasil=5 class>5 detik</button>
...
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
                            ...
                            <div style="text-align: center; margin-top: 15px">
                                <button id="tombol-ulangi-tes" class="btn btn-primary d-none">Ulangi Tes</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            localStorage.setItem('jBenar50', 0);
                localStorage.setItem('jSalah50', 0);
            // let ja = localStorage.jBenar50 = 0;
            // let jk = localStorage.jSalah50 = 0;
            ...
            document.querySelector("#tampil-nomor p:nth-of-type(3)").innerHTML = 2; // Replace 7 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(4)").innerHTML = 8; // Replace 2 with your desired number
            document.querySelector("#tampil-nomor p:nth-of-type(5)").innerHTML = 9; // Replace 9 with your desired number
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar50;
                document.getElementById("jumlah-salah").innerHTML = jSalah50;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar50', jBenar50);
                localStorage.setItem('jSalah50', jSalah50);
                localStorage.setItem('scores50',  JSON.stringify(scores50));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar50');
                const jSalahLocal = localStorage.getItem('jSalah50');
                const scores50Local = localStorage.getItem('scores50');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores50Local !== null && scores50Local.trim() !== "") {
                        jBenar50 = parseInt(jBenarLocal);
                        jSalah50 = parseInt(jSalahLocal);
                        scores50 = JSON.parse(scores50Local); // Parse JSON string to array
...
//akhirLocalStorage
            ...
            //    timer.innerHTML = (`0${waktu / 60}`).slice(-2) + ":00";
                ...
                document.getElementById("tampil-nomor").style.display = "block";
            }
    ...
    function decrement() {
        ...
        if (count < 0) {
             // Call tampilHasil when the countdown reaches 0
...
//         type: 'line',
//         data: {
//             labels: riwayatLabel, // Ganti dengan array label Anda
//             datasets: [{
//                 label: 'Jumlah Jawab',
//                 data: data, // Ganti dengan array data Anda
//                 borderWidth: 1
//             }]
//         },
//         options: {
...
//akhirLocalstorage
                    ...
                    const angkaArray = [4, 5, 4, 5, 9, 6, 4, 6, 7, 9, 6, 6, 7, 6, 7, 9, 6, 6, 7, 9, 9, 8, 5];
       ...
       localStorage.jBenar50 = 0;
       localStorage.jSalah50 = 0;
       localStorage.scores50 =[];
    </script>
