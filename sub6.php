...
<head>
<script defer>
    sub4 = localStorage.getItem('scores5');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar6;
                document.getElementById("jumlah-salah").innerHTML = jSalah6;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar6', jBenar6);
                localStorage.setItem('jSalah6', jSalah6);
                localStorage.setItem('scores6',  JSON.stringify(scores6));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar6');
                const jSalahLocal = localStorage.getItem('jSalah6');
                const scores6Local = localStorage.getItem('scores6');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores6Local !== null && scores6Local.trim() !== "") {
                        jBenar6 = parseInt(jBenarLocal);
                        jSalah6 = parseInt(jSalahLocal);
                        scores6 = JSON.parse(scores6Local); // Parse JSON string to array
            ...
            function decrement() {
                ...
                if (count < 0) {
                    document.location.href = 'sub7.php'
                } else {
            ...
            document.querySelectorAll("#tombol-nomor div").forEach((tn) => {
                tn.addEventListener("click", async () => {
                    ...
                    const angkaArray = [6, 4, 3, 6, 9, 8, 7, 0, 9, 8, 8, 5, 1, 9, 6, 0, 5, 4, 5, 9, 6, 6, 7];
        ...
        localStorage.jBenar6 = 0;
       localStorage.jSalah6 = 0;
       localStorage.scores6 =[];
    </script>
</body>
