...
<head>
<script defer>
    sub4 = localStorage.getItem('scores6');
    if (!sub4) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar7;
                document.getElementById("jumlah-salah").innerHTML = jSalah7;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar7', jBenar7);
                localStorage.setItem('jSalah7', jSalah7);
                localStorage.setItem('scores7',  JSON.stringify(scores7));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar7');
                const jSalahLocal = localStorage.getItem('jSalah7');
                const scores7Local = localStorage.getItem('scores7');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores7Local !== null && scores7Local.trim() !== "") {
                        jBenar7 = parseInt(jBenarLocal);
                        jSalah7 = parseInt(jSalahLocal);
                        scores7 = JSON.parse(scores7Local); // Parse JSON string to array
            ...
            function decrement() {
                ...
                if (count < 0) {
                    document.location.href = 'sub8.php'
                } else {
            ...
            document.querySelectorAll("#tombol-nomor div").forEach((tn) => {
                tn.addEventListener("click", async () => {
                    ...
                    const angkaArray = [9, 5, 8, 5, 9, 6, 4, 5, 8, 5, 9, 5, 5, 1, 0, 6, 2, 8, 9, 7, 5, 8, 6];
        ...
        localStorage.jBenar7 = 0;
       localStorage.jSalah7 = 0;
       localStorage.scores7 =[];
    </script>
</body>
