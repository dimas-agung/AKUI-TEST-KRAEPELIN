...
<head>
<script defer>
    sub4 = localStorage.getItem('scores8');
    if (!sub4) {
                ...
                <div class="card shadow-sm" style="height: 100%;">
                    ...
                    <img id="logo" class="logo-non-tes"
                        ...
                        <div id="petunjuk" class="kelompok kelompok-non-tes d-none">
                            <h2 class="judul">Tes Kraepelin</h2>
                            <p>Petunjuk</p>
                        ...
                        <div id="hasil" class="kelompok kelompok-non-tes d-none">
                            <h2 class="judul" style="position: relative">Tes Kraepelin<span id="hasil-waktu-tes"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updateTampilanJumlah() {
                document.getElementById("jumlah-benar").innerHTML = jBenar9;
                document.getElementById("jumlah-salah").innerHTML = jSalah9;
            }

            // Fungsi untuk menyimpan data ke localStorage
            function simpanKeLocalStorage() {
                localStorage.setItem('jBenar9', jBenar9);
                localStorage.setItem('jSalah9', jSalah9);
                localStorage.setItem('scores9',  JSON.stringify(scores9));
            }

            // Fungsi untuk mengambil data dari localStorage
            function ambilDariLocalStorage() {
                const jBenarLocal = localStorage.getItem('jBenar9');
                const jSalahLocal = localStorage.getItem('jSalah9');
                const scores9Local = localStorage.getItem('scores9');

                // Periksa apakah data tersedia di localStorage
                if (jBenarLocal !== null && jSalahLocal !== null && scores9Local !== null && scores9Local.trim() !== "") {
                        jBenar9 = parseInt(jBenarLocal);
                        jSalah9 = parseInt(jSalahLocal);
                        scores9 = JSON.parse(scores9Local); // Parse JSON string to array
            ...
            function decrement() {
                ...
                if (count < 0) {
                    document.location.href = 'sub10.php'
                } else {
            ...
            document.querySelectorAll("#tombol-nomor div").forEach((tn) => {
                tn.addEventListener("click", async () => {
                    ...
                    const angkaArray = [4, 0, 9, 1, 5, 5, 5, 1, 0, 6, 5, 5, 1, 4, 6, 7, 9, 5, 9, 5, 5, 1, 6];
        ...
        localStorage.jBenar9 = 0;
       localStorage.jSalah9 = 0;
       localStorage.scores9 =[];
    </script>
</body>
